 ...
 */
class DynamicActiveRecordTestJson extends ActiveRecordTest
{
    /** @var Connection */
    protected $db;
...
*/
    public function dataProviderTestWriteRead()
    {
        $data = [
            ['int', 1234],
            ['neg', -4321],
          //  ['octal', 076543], base 10 numbers only in json 
          //  ['hex', 0xbada55],
            ['largeint', 2147483647],
            ...
            ['string1', "this is a simple string"], //all strings should be double quoted
    ...
    { 
        $expected = [
            'str' => 'str',
         //   'char' => 'char', // all these are strings in json.
        //    'date' => '1999-12-31',  
...
//            'unsigned' => new ValueExpression(321, 'UNSIGNED'),
    ...
    { //this will not work, to use where in a jsonb column you have to practicaly
     //create a temp table and search within
     //------------------- something like this will work--------
     //select * from product where id IN(
     //with myproduct as (select "id", dynamic_columns::jsonb#>>'{"path","path","element"}' as "myvar" from product)
     //select person_id from myproduct where "myvar" =:v)
